...
object LiquidBounce {
    ...
    const val CLIENT_NAME = "FDPNextgen"

    var Darkmode = true
    const val COLORED_NAME = "§7[§b§lFDPNextgen§7] "
    const val CLIENT_CREATOR = "CCBlueX, Zywl & SkidderMC TEAM, Dinnerb0ne"
